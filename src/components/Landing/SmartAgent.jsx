  ...
  return (
    <section className="relative w-full bg-white py-20 !mt-20 flex flex-col items-center">
      ...
      <img
        ...
        className="absolute -left-20 top-[100%] transform -translate-y-1/2 w-auto h-auto object-contain pointer-events-none z-19 hidden sm:hidden md:block"
      />
      {/* Centered container matching other sections */}
      <div className="w-full max-w-[calc(80rem+10rem)] py-4! !px-4 md:!px-6 lg:!px-10 xl:!px-12">
        ...
        <div className="flex flex-wrap items-stretch !gap-3 md:!gap-4 !mt-2 md:grid md:grid-cols-3">
          ...
          <div className="basis-full md:col-span-2 z-20 h-full min-w-0 bg-white/80 backdrop-blur-md rounded-2xl border border-white/20 !p-6 overflow-hidden shadow-lg flex flex-col md:flex-row items-start" style={{background: 'var(--card-gradient)'}}>
            {/* Left Content */}
